...
if __name__ == "__main__":
    ...
    sudoku.creer_partie(((0,0,8),
                        (0,5,5), (0,8,7), (1,1,9),
                        (1,6,6), (1,7,3), (2,1,4), (2,3,7),
                        (2,4,2), (3,0,4), (3,4,1), (3,6,2),
                        (4,2,6), (4,3,8),
                        (4,5,4), (4,6,1), (5,2,9), (5,4,5),
                        (5,8,4), (6,4,3), (6,5,1), (6,7,8),
                        (7,1,6), (7,2,8), (7,7,9),
                        (8,0,5),(8,3,9),(8,8,1)))
    
    #24
    """
    sudoku.creer_partie(((0,2,6),
                        (0,4,7), (0,6,3), (1,3,4),
                        (1,5,5), (2,0,5), (2,3,6), (2,8,1),
                        (3,1,8), (3,6,6), (3,7,5), (4,0,2),
                        (4,8,8), (5,1,3),
                        (5,2,4), (5,7,2), (6,0,6), (6,5,2),
                        (6,8,7), (7,3,8), (7,5,9), (8,2,8),
                        (8,4,6), (8,6,1)))
    """
    sudoku.afficher()
