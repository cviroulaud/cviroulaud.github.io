...
\fancyhead[L]{Correction exercices arbre binaire}
...
\begin{Form}
    ...
    \begin{exo}
        \begin{enumerate}
            ...
            \item Les parents
                  \lstinputlisting[firstline=17,lastline=20]{"scripts/arbre-genealogique-correction.py"}
            \item Pour parcourir le sous-arbre gauche en premier il faut empiler d'abord l'indice impair.
                  \lstinputlisting[firstline=22,lastline=34]{"scripts/arbre-genealogique-correction.py"}
            \item Dans ce cas c'est l'indice pair qui est utilisé en premier dans les appels.
                  \lstinputlisting[firstline=36,lastline=44]{"scripts/arbre-genealogique-correction.py"}
        \end{enumerate}
    \end{exo}
    \begin{exo}
        \begin{enumerate}
