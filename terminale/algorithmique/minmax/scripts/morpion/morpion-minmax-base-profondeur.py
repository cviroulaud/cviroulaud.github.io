...
#DODO fonction d'évaluation qui regarde la longueur des alignements de l'adversaire
    ...
    for ligne in range(3):
        for colonne in range(3):
            ...
            if grille[ligne][colonne] == 0:
                ...
                score = mini(grille, (ligne, colonne), profondeur)
...
def maxi(grille: list, coord: tuple, profondeur: int) -> int:
    """
    ...
    for ligne in range(3):
        for colonne in range(3):
            ...
            if grille[ligne][colonne] == 0:
                grille[ligne][colonne] = IA
                score = mini(grille, coord, profondeur+1)
                if score > score_max:
                    score_max = score
                grille[ligne][colonne] = 0
    return score_max
...
def mini(grille: list, coord: tuple, profondeur: int) -> int:
    """
    ...
    for ligne in range(3):
        for colonne in range(3):
            ...
            if grille[ligne][colonne] == 0:
                ...
                score = maxi(grille, coord, profondeur+1)
                if score < score_min:
                    score_min = score
                grille[ligne][colonne] = 0
    return score_min
