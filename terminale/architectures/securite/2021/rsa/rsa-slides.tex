...
\begin{frame}
    ...
    \begin{center}
        \lstinputlisting[firstline=10 ,lastline=20,basicstyle=\small,xleftmargin=2em,xrightmargin=2em ]{"scripts/kidrsa.py"}
...
\begin{frame}
    ...
    \begin{center}
        \lstinputlisting[firstline=23 ,lastline=32,basicstyle=\small,xleftmargin=2em,xrightmargin=2em  ]{"scripts/kidrsa.py"}
    \captionof{code}{Bob chiffre son message avec la clé publiqe d'Alice}
    \end{center}
...
\begin{frame}
    ...
    \begin{center}
        \lstinputlisting[firstline=35 ,lastline=44,basicstyle=\small,xleftmargin=2em,xrightmargin=2em  ]{"scripts/kidrsa.py"}
